from turtle import mainloop, listen, onclick, onkey, bye, setposition, left, right, speed, hideturtle, forward, color, penup, pendown, bgcolor, begin_fill, end_fill
...
def star():  # nekonečně generuje nové hvězdy
    penup()
