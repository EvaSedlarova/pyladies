...
# Kočku můžeš nakrmit metodou eat, která bere 1 argument - nějaké konkrétní jídlo (řetězec).
# Pokud je toto jídlo "fish", kočce se obnoví jeden život (pokud teda už není mrtvá, nebo nemá maximální počet životů).
